...
gene_prompts = {
    'yn':{
        'task_desc': '',
        'source_node_intro': 'This is the source gene:\n',
        'candidate_target_node_intro': 'This is another gene:\n',
        'connection_question': 'Is this gene regulate the source gene?\n',
    },
    'np':{
        'task_desc': '',
        'source_node_intro': 'This is the source gene:\n',
        'question': 'What genes does this gene regulate?\n',
    }
}
...
def get_prompts(dataset_name: str, task_name: str, allow_general_prompts: bool = True):
    ...
    elif dataset_name.startswith('grn'):
        prompts = gene_prompts
    else:
